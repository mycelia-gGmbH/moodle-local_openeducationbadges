...
/**
 * Class containing data for profile page
 *
 * @package    local_openeducationbadges
 * @copyright  2024 Esirion AG
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class profile_page implements renderable, templatable {
     ...
     */
    public function __construct($email, $client, $context) {
        $this->email = $email;
        $this->client = $client;
    ...
    public function export_for_template(renderer_base $output): \stdClass {
        ...
        $data->iframeurl = $this->client->get_user_backpack_iframe_url(
            $this->email,
            $CFG->lang
        );
    ...
    public function get_template_name(renderer_base $renderer): string {
        return 'local_openeducationbadges/profile_page';
    }
}
