...
$string['all'] = 'All';
$string['award'] = 'award';
$string['badgecreatefor'] = 'create new badge for \'{$a}\'';
$string['badgeedit'] = 'edit';
$string['badgelist'] = 'List of badges';
$string['badgelisttitle'] = 'All badges';
$string['badgesplatform'] = 'Open Educational Badges earned';
...
$string['quotaexceeded_badgeaward'] = 'Upper limit reached. You have reached the upper limit of the booked scope of services for issued badges. Please upgrade your package to continue.';
$string['quotaexceeded_badgeaward_withpackage'] = 'Upper limit reached. You have reached the upper limit of the booked scope of services for issued badges. This requires an upgrade to our {$a} package.';
$string['issuers'] = 'Issuers';
$string['issuerscustomize'] = 'Customize issuers';
$string['issuerssaved'] = 'Issuers customized';
$string['nobadgegiven'] = 'No badge given';
$string['nobadges'] = 'No badge';
$string['nobadgesearned'] = 'No badges earned yet';
$string['noiframeurl'] = 'The iframe URL is currently unavailable.';
$string['noissuergiven'] = 'No issuer given';
